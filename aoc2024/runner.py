"""Advent of Code: 2024 - Run All The Things."""
...
def generate_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="aoc2024",
        description="Advent of Code: 2024 (@Tribruin)",
        epilog="Ho Ho Ho!",
...
def run() -> None:
    ...
    if args.test:
        ...
        pytest.main([f"aoc2024/{day}.py" for day in days])
        return
    ...
    table = Table(title="Advent of Code: 2024 (@Tribruin)", row_styles=["", "dim"])
